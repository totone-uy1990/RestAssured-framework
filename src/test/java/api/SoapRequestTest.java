...
public class SoapRequestTest {
    ...
    public void testSoarequest() {
        ...
        Response response2 = given()
                .contentType("text/xml; charset=UTF-8")// es un header que indica el tipo de contenido que se está
                                                       // enviando en la solicitud, en este caso, XML con codificación
                                                       // UTF-8.
                .baseUri("https://www.dataaccess.com")
                .basePath("/webservicesserver/NumberConversion.wso")
                .body(bodySoapNormalInput)
        ...
        System.out.println(ANSI_GREEN
                + "ESTE ES EL CUEROPO DE LA RESPUESTA: DE LA FORMA 2: "
                + response2.getBody().asString());
        String numberInWords = response2.xmlPath().getString("NumberToWordsResponse.NumberToWordsResult");

        Assert.assertEquals(numberInWords.trim(), "five hundred");
        /*
    ...
    public void testSoapRequestNegative() {
        ...
        given()
                ...
                .then()
                .log().all()
                .statusCode(500); // El servicio deberia devolver un error 500 para entradas no numéricas
    }
}
